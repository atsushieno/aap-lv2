...
There are also dedicated repos for non-trivial LV2 plugin ports and so on (not everything works as expected) listed at [AAP Wiki](https://github.com/atsushieno/aap-core/wiki/List-of-AAP-plugins-and-hosts).

[AAP FAQ](https://github.com/atsushieno/aap-core/wiki/FAQ) covers some topics related to aap-lv2 too.
...
- Create `aap_metadata.xml` (or generate it using `aap-import-lv2-metadata` tool)
